...
impl Auth for AuthService {
    async fn sign_in(
        ...
        let result: Option<String> = self.users_service.lock()
            .expect("Couldn't get lock for users service")
    ...
    async fn sign_up(
        ...
        let result: Result<(), String> = self.users_service.lock()
            .expect("Couldn't lock user service in signup")
    ...
    async fn sign_out(
        ...
        self.sessions_service.lock().expect("Couldn't lock session in signout").delete_session(&req.session_token);
